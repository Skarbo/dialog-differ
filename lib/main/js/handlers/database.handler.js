...
var DatabaseHandler = function () {
  ...
  (0, _createClass3.default)(DatabaseHandler, [{
    ...
    value: function saveDialogsResult(_ref) {
      var _this6 = this;

      var options = _ref.options,
          dialogsResult = _ref.dialogsResult;
    ...
    value: function getDialogsResult(_ref2) {
      var _this7 = this;

      var options = _ref2.options,
          dialogId = _ref2.dialogId,
          originalVersion = _ref2.originalVersion,
    ...
    key: 'deleteSuiteResults',
    value: function () {
      var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(keepLatest) {
        var _this14 = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return this.getLastSuiteResults();

              case 3:
                suiteResults = _context.sent;
                _context.next = 6;
                return _promise2.default.all(suiteResults.slice(keepLatest).map(function (suiteResult) {
                  return _this14.deleteSuiteResult(suiteResult.id);
                }));
              ...
              case 9:
                ...
                throw ErrorHelper.createError(_context.t0, 'Could not delete suite result', ERROR_CONSTANTS.DELETE_SUITE_RESULTS_DB_ERROR, { keepLatest: keepLatest });
      ...
      function deleteSuiteResults(_x3) {
        return _ref3.apply(this, arguments);
      }

      return deleteSuiteResults;
    }()
  }]);
