  ...
  (0, _createClass3.default)(DifferHandler, [{
    ...
    value: function differDialogScreenshot(screenshotOriginal, screenshotCurrent) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        looksSame(screenshotCurrent.path, screenshotOriginal.path, {
          strict: false,
          tolerance: _this.config.diffTolerance
          ...
          // diff
              ...
              looksSame.createDiff({
                ...
                highlightColor: _this.config.diffHighlightColor,
                strict: false,
                tolerance: _this.config.diffTolerance
              }, function (err, buffer) {
                var diff = Buffer.from(buffer);
    ...
    value: function () {
      ...
      function differDialog(_x3, _x4, _x5) {
    ...
    value: function () {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                _context2.next = 10;
                return this.databaseHandler.saveDialogsResult({ options: options, dialogsResult: dialogsResult });
      ...
      function differDialogWithImageDiff(_x7, _x8, _x9) {
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                ...
                return Promise.map(suiteResult.results, function (result) {
                  return _this3.differDialog(suite.options, result.original, result.current, { onDiff: onDiff });
                }, { concurrency: 10 });
    ...
    value: function () {
      ...
      function finishSuiteResult(_x14) {
    ...
    value: function () {
      ...
      function errorSuiteResult(_x15, _x16) {
