...
var HASH_DIALOGS_COLLECTIONS = 10;
...
var SnapHandler = function () {
  ...
  (0, _createClass3.default)(SnapHandler, [{
              ...
              case 4:
                ...
                return Promise.all([].concat(dialogsCollection.snappedCollection.map(function (par) {
                  ...
                  if (Array.isArray(par)) {
                    ...
                    return _this2.snapDialogFromDatabase(par.dialog, par.screenshots, { onSnap: onSnap });
                  }
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 4:
                ...
                _context5.next = 8;
                return this.snapDialogFromDatabase(dialog, dialogScreenshotsDb, { onSnap: onSnap });
              ...
              case 10:
                _context5.next = 12;
                return this.snapDialogFromBrowser(options, dialog, { onSnap: onSnap });
              ...
              case 16:
                ...
                // callback
                if (onSnap) {
                  onSnap(dialog, { err: _context5.t0 });
                }
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 8:
                ...
                // callback
                if (onSnap) {
                  onSnap(dialog, { err: _context6.t0, isDatabase: true });
                }
    ...
    value: function () {
      var _ref16 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee13(options, dialogs) {
        var _this5 = this;

        var _ref17 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
            onSnap = _ref17.onSnap;

        var dialogUrl, dialogVersion, dialogsCollections;
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                ...
                dialogsCollections = dialogs.reduce(function (rows, key, index) {
                  return (index % HASH_DIALOGS_COLLECTIONS === 0 ? rows.push([key]) : rows[rows.length - 1].push(key)) && rows;
                }, []);
                ...
                function () {
                  var _ref18 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee12(dialogsCollection) {
                      ...
                      while (1) {
                        switch (_context12.prev = _context12.next) {
                          case 0:
                            ...
                            logger.log(TAG, 'snapDialogsWithHashFromBrowser', 'Snapping %d dialogs with hash from browser', null, dialogsCollection.length, dialogsCollection.map(function (dialog) {
                              return dialog.id;
                            }));
                          ...
                          case 16:
                            ...
                            function () {
                              var _ref19 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee11(dialog) {
                                var sizes, error;
                                  ...
                                  while (1) {
                                    switch (_context11.prev = _context11.next) {
                                      ...
                                      case 10:
                                        _context11.next = 12;
                                        return Promise.each(sizes, function () {
                                          var _ref20 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee10(size) {
                                            var newSize;
                                      ...
                                      case 15:
                                        ...
                                        error = ErrorHelper.createError(_context11.t0, 'Could not snap dialog \'%s\' version \'%s\' with hash from Browser. Url: \'%s#%s\'. Version: \'%s\'.', ERROR_CONSTANTS.SNAP_DIALOG_WITH_HASH_FROM_BROWSER_ERROR, lastDialog.id, lastDialog.version, dialogUrl, lastDialog.hash);
                          ...
                          case 20:
                            ...
                            error = ErrorHelper.createError(_context12.t0, 'Could not snap dialogs with hash from Browser. Url: \'%s#%s\'. Version: \'%s\'. Id: \'%s\'.', ERROR_CONSTANTS.SNAP_DIALOGS_WITH_HASH_FROM_BROWSER_ERROR, dialogUrl, lastDialog.hash, dialogVersion, lastDialog.id);
