  ...
  (0, _createClass3.default)(SnapHandler, [{
    ...
    value: function () {
      var _ref16 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee12(options, dialogs) {
        ...
        var dialogUrl, dialogVersion, dialogId, dialogHashList, lastDialogId, browser, page, error;
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 24:
                ...
                error = ErrorHelper.createError(_context12.t0, 'Could not snap dialogs with hash from Browser. Url: \'%s\'. Version: \'%s\'. First id: \'%s\'. Last dialog id: \'%s\'. Hash list: \'%s\'.', ERROR_CONSTANTS.SNAP_DIALOGS_WITH_HASH_FROM_BROWSER_ERROR, dialogUrl, dialogVersion, dialogId, lastDialogId, dialogHashList.join(', '));
