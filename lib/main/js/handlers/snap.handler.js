...
var SnapHandler = function () {
  ...
  (0, _createClass3.default)(SnapHandler, [{
              ...
              case 4:
                ...
                return Promise.all([].concat(dialogsCollection.snappedCollection.map(function (par) {
                  ...
                  if (Array.isArray(par)) {
                    ...
                    return _this2.snapDialogFromBrowser(options, par.dialog, { onSnap: onSnap, isOriginal: isOriginal, isCurrent: isCurrent });
                  }
                })));
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                logger.info(TAG, 'snapDialogFromDatabase', '[dialog_version=%s][dialog_id=%s][dialog_screenshots=%d]', 'Dialog \'%s\' using \'%d\' screenshots from database', LOGGER_CONSTANTS.SCREENSHOTS_FROM_DATABASE_LOGGER, dialog.version, dialog.id, dialogScreenshotsDb.length);
    ...
    value: function () {
      var _ref15 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee9(dialogs, dialogsScreenshotsDb, _ref16) {
        var _this4 = this;

        var onSnap = _ref16.onSnap,
      ...
      function snapDialogsWithHashFromDatabase(_x21, _x22, _x23) {
    ...
    value: function () {
      var _ref17 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee14(options, dialogs) {
        var _this5 = this;

        var _ref18 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
            onSnap = _ref18.onSnap,
            _ref18$isOriginal = _ref18.isOriginal,
            isOriginal = _ref18$isOriginal === undefined ? false : _ref18$isOriginal,
            _ref18$isCurrent = _ref18.isCurrent,
            isCurrent = _ref18$isCurrent === undefined ? false : _ref18$isCurrent;
            ...
            switch (_context14.prev = _context14.next) {
              case 0:
                ...
                dialogsCollections = this.config.snapDialogsWithHashFromBrowserCollections ? dialogs.reduce(function (rows, key, index) {
                  return (index % _this5.config.snapDialogsWithHashFromBrowserCollections === 0 ? rows.push([key]) : rows[rows.length - 1].push(key)) && rows;
                }, []) : [dialogs];
                ...
                createAndGoToPage = function () {
                  var _ref19 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee10(browser, dialog) {
                    var page;
                      ...
                      while (1) {
                        switch (_context10.prev = _context10.next) {
                          ...
                          case 2:
                            ...
                            _context10.next = 6;
                            return page.goto(dialog.url, {
                              timeout: _this5.config.browserTimeout
                            });
                          ...
                          case 8:
                            return _context10.abrupt('return', page);
                  ...
                  return function createAndGoToPage(_x27, _x28) {
                ...
                _context14.next = 8;
                return Promise.map(dialogsCollections,
                /** @param {Array<DialogDiffer.Dialog>} dialogsCollection */
                function () {
                  var _ref20 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee13(dialogsCollection) {
                      ...
                      while (1) {
                        switch (_context13.prev = _context13.next) {
                          case 0:
                            ...
                            logger.info(TAG, 'snapDialogsWithHashFromBrowser', '[dialog_version=%s][dialogs=%d][dialog_url=%s][dialog_sizes=%s]', LOGGER_CONSTANTS.SNAP_DIALOG_WITH_HASH_FROM_BROWSER_LOGGER, dialogVersion, dialogsCollection.length, dialogUrl, dialogSizes.map(function (_ref21) {
                            ...
                            return puppeteer.launch((0, _extends3.default)({
                              timeout: _this5.config.browserTimeout
                            }, _this5.config.puppeteerLaunchOptions));

                          case 7:
                            browser = _context13.sent;
                            _context13.next = 10;
                          ...
                          case 10:
                            ...
                            _context13.next = 13;
                            return Promise.each(dialogsCollection,
                            /** @type {DialogDiffer.Dialog} dialog */
                            function () {
                              var _ref22 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee12(dialog) {
                                var sizes, error;
                                  ...
                                  while (1) {
                                    switch (_context12.prev = _context12.next) {
                                      ...
                                      case 9:
                                        _context12.next = 11;
                                        return Promise.each(sizes, function () {
                                          var _ref23 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee11(size) {
                                            var newSize;
                                      ...
                                      case 14:
                                        ...
                                        error = ErrorHelper.createError(_context12.t0, '[dialog_version=%s][dialog_id=%s][dialog_url=%s#%s][error=%s]', ERROR_CONSTANTS.SNAP_DIALOG_WITH_HASH_FROM_BROWSER_ERROR, lastDialog.version, lastDialog.id, dialogUrl, lastDialog.hash, _context12.t0.message);
                          ...
                          case 15:
                            ...
                            error = ErrorHelper.createError(_context13.t0, '[dialog_version=%s][dialog_id=%s][dialogs=%d][dialogs_with_error=%d][dialog_url=%s][error=%s]', ERROR_CONSTANTS.SNAP_DIALOGS_WITH_HASH_FROM_BROWSER_ERROR, dialogVersion, lastDialog.id, dialogsCollection.length, dialogsCollection.filter(function (dialog) {
                              return !!dialog.error;
                            }).length, dialogUrl, _context13.t0.message);
              ...
              case 8:
                return _context14.abrupt('return', dialogs);
      ...
      function snapDialogsWithHashFromBrowser(_x24, _x25) {
