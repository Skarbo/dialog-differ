...
var puppeteerScreenshot = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(page, dialog, size, databaseHandler) {
        var _this = this;
...
var SnapHandler = function () {
    ...
    function SnapHandler(databaseHandler) {
        _classCallCheck(this, SnapHandler);
    ...
    _createClass(SnapHandler, [{
        key: 'snapSuite',
        value: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(suite) {
        ...
        value: function () {
            var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(options, dialogs) {
                var _this2 = this;
        ...
        key: 'snapDialog',
        value: function () {
            var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(options, dialog) {
        ...
        value: function () {
            var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(dialog, dialogScreenshotsDb) {
        ...
        value: function () {
            var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(options, dialog) {
                var _this3 = this;
                        ...
                        switch (_context8.prev = _context8.next) {
                            ...
                            case 19:
                                ...
                                return Promise.each(sizes, function () {
                                    var _ref13 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(size) {
                                        var newSize;
                            ...
                            case 24:
                                ...
                                error = ErrorHelper.createError(_context8.t0, 'Could not snap dialog from Browser. Version: \'%s\'. Id: \'%s\'. Url: \'%s\'.', ERROR_CONSTANTS.SNAP_DIALOG_FROM_BROWSER_ERROR, dialog.version, dialog.id, dialog.url, { options: options });
                                ...
                                logger.error.apply(logger, [TAG, 'snapDialogFromBrowser', error.message, error.code].concat(_toConsumableArray(error.args), [error.stack]));
        ...
        value: function () {
            var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(dialogs, dialogsScreenshotsDb, _ref15) {
                var _this4 = this;
        ...
        value: function () {
            var _ref16 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(options, dialogs) {
                var _this5 = this;
                    ...
                    while (1) {
                        switch (_context12.prev = _context12.next) {
                            ...
                            case 10:
                                ...
                                function () {
                                    var _ref18 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(dialog) {
                                        var sizes, page;
                                            ...
                                            while (1) {
                                                switch (_context11.prev = _context11.next) {
                                                    ...
                                                    case 17:
                                                        _context11.next = 19;
                                                        return Promise.each(sizes, function () {
                                                            var _ref19 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(size) {
                                                                var newSize;
                            ...
                            case 15:
                                ...
                                logger.error.apply(logger, [TAG, 'snapDialogsWithHashFromBrowser', error.message, error.code].concat(_toConsumableArray(error.args), [error.stack]));
