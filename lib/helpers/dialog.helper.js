...
module.exports.isDialogSnapped = function (sizes, dialog, dialogScreenshotsDb) {
    ...
    sizes = Array.from(sizes).sort(function (size) {
        return size.width;
    });
    var sortedDialogScreenshotsDb = Array.from(dialogScreenshotsDb).sort(function (dialogScreenshotDb) {
...
module.exports.collectSnappedDialogs = function (options, dialogs, dialogsScreenshotsDb) {
    ...
    return {
        snappedCollection: Object.keys(snappedCollection).map(function (url) {
            return snappedCollection[url];
        }),
        nonSnappedCollection: Object.keys(nonSnappedCollection).map(function (url) {
