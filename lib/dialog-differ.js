...
var DialogDiffer = function () {
    function DialogDiffer() {
        _classCallCheck(this, DialogDiffer);
    }

    _createClass(DialogDiffer, null, [{
        key: 'diff',
        ...
        value: function getSuiteResult(suiteId, database) {
            return new Promise(function (fulfill, reject) {
                ...
                databaseHandler.initDB(null, database).then(function () {
                    ...
                    return Promise.all(suiteResultDb.results.map(function (suiteResultDialogsResultDb) {
                        return new Promise(function (fulfill, reject) {
                ...
                function (results) {
                    ...
                    return Promise.all(suiteResult.results.map(function (suiteResultDialogsResultDb) {
                        return new Promise(function (fulfill, reject) {
